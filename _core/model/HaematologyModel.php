...
class HaematologyModel extends BaseModel{
    ...
    public function getTestDetails($testId, $treatmentId, $encounterId){
        ...
        $result['blood_test'] = $this->getBloodTestDetails($testId);
        $result['differential_count'] = $this->getDifferentialCountTestDetails($testId);
        $result['film_appearance'] = $this->getFilmAppearanceTestDetails($testId);
...
/*------------------------------------------ Blood Test Section -----------------------------------------*/
    ...
    private function getBloodTestDetails($testId){
        $data = array(HaematologyTable::haematology_id => $testId);
...
/*------------------------------------- Film Appearance Section ----------------------------------------*/
    ...
    private function getFilmAppearanceTestDetails($testId){
        $data = array(HaematologyTable::haematology_id => $testId);
...
/*------------------------------- Differential Count Section --------------------------------------------*/
    private function getDifferentialCountTestDetails($testId){
        $data = array(HaematologyTable::haematology_id => $testId);
